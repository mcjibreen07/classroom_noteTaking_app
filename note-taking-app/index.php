...
<body>
    ...
    <button   class="btn btn-secondary submit-btn" onclick="btn_click()" style="width: 20%;font-weight:bold;background-color: #59ad5d; color: #fff; padding: 8px 12px; border: none; border-radius: 4px; cursor: pointer;"> Go to Vitual Class </button>
                            ...
                            ?>
                                <li class="list-group-item mt-2">
                                    <div class="btn-group float-right">
                                        ...
                                        <button onclick="speakText('<?php echo $noteContent ?>')" type="button" class="btn btn-sm btn-light" title="Speak"><i class="fas fa-volume-up"></i></button>
 ...
 */
        ...
        var destinationURL = "/Enhanced/classroom/";
        function btn_click(){
